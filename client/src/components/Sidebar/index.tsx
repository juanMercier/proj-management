...
const Sidebar = () => {
    ...
    const sideClassnames = `fixed flex flex-col h-[100%] justify-between shadow-xl transition-all duration-300 h-full z-40 dark:bg-black [&::-webkit-scrollbar]:hidden overflow-y-auto bg-white ${isSidebarCollapsed ? "w-0 hidden" : "w-64"}`
        ...
        <div className={sideClassnames}>
            <div className='flex h-[100%] w-full flex-col justify-start'>
                ...
                <div className='flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700'>
                    <Image src="https://proj-manag.s3.amazonaws.com/logo.png" alt="Logo" width={40} height={40} />
                    <div>
                ...
                <div className='flex w-full items-center'>
                    <div className='align-center flex h-9 w-9 justify-center'>
                        {!!currentUserDetails?.profilePictureUrl ? (
                            <Image
                                src={`https://proj-manag.s3.amazonaws.com/${currentUserDetails?.profilePictureUrl}`}
                    ...
                    <button
                        className='self-start rounded bg-blue-600 px-4 py-2 text-xs font-bold text-white hover:bg-blue-500 md:block'
