...
import { Home,Link, LockIcon, LucideIcon } from 'lucide-react';
...
const Sidebar = () => {
    ...
    const sideClassnames = 'fixed flex flex-col h-[100%] justify-between shadow-xl transition-all duration-300 h-full z-40 dark:bg-black overflow-y-auto bg-white w-64'
